CREATE VIEW raport_handlowcow AS
 SELECT gotowe.tr_zaliczonedla,
    gotowe.tgr_idgrupy,
    gotowe.data_wystawienia_miesiac,
    gotowe.zaplacone,
    gotowe.zysk,
   ...
   FROM ((( SELECT got.tr_zaliczonedla,
           ...
           FROM ( SELECT tmp.tr_zaliczonedla,
                   ...
                   FROM ((( SELECT tg_transakcje.tr_idtrans,
                            ...
                            (((date_part('year'::text, tg_transakcje.tr_datawystaw))::text || '.'::text) || uzupelnijmiesiac((date_part('month'::text, tg_transakcje.tr_datawystaw))::text)) AS data_wystawienia_miesiac,
          ...
          GROUP BY got.tr_zaliczonedla, got.tgr_idgrupy, got.data_wystawienia_miesiac) gotowe

CREATE FUNCTION doskojtrans(integer, integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $_$
BEGIN
...
CREATE FUNCTION doskojtrans(integer, integer, integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $_$
BEGIN
...
CREATE FUNCTION doskojtrans(integer, integer, integer, integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $_$
DECLARE

CREATE FUNCTION wyliczeniezapotrzebowaniawgmatplanuzlecenia(integer, integer, integer, date, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric) RETURNS integer
    LANGUAGE plpgsql
    AS $_$
DECLARE
